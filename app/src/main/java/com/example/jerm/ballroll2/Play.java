...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSimulationView.setBackgroundResource(R.drawable.stars);
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        class Particle extends View {
            ...
            public void computePhysics(float sx, float sy, float dT) {
                ...
                final float ax = -sx/20;
                final float ay = -sy/20;

                mPosX += mVelX * dT + ax * dT * dT / 2;
                mPosY += mVelY * dT + ay * dT * dT / 2;

                mVelX += ax * dT - mVelX*0.03;
                mVelY += ay * dT - mVelY*0.03;
